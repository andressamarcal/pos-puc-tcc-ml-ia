...
from classification_customize import customize
...
st.sidebar.image("../img/logo-portocred.png")

container = st.sidebar.slider(
    label="Display-size", min_value=300, max_value=3000, value=1400, step=100
)
...
def main():
    global dict_values_not_tuning, dict_values_tuning, df_abt, df_oot
    ...
    if TYPE == "Classificação":
        ...
        try:
            ...
            with col09:
                ...
                shutil.copy("Gain Chart.png", "Gain_train.png")
                st.image("Gain_train.png")
        ...
        try:
            ...
            with col12:
                ...
                shutil.copy("Gain Chart.png", "Gain_tuned.png")
                st.image("Gain_tuned.png")
        ...
        col111, col121 = st.beta_columns(2)
        ...
        try:
            if (
                ...
                model_name = "portocred_automl_sem_OOT_sem_tuned_{}".format(date.today())
                ...
                model_name = "portocred_automl_sem_OOT_com_tuned_{}".format(date.today())
            ...
            prc = predictions.groupby(["GH"])[TARGET].sum()/predictions.groupby(['GH'])[TARGET].count()
        ...
        try:
            ...
            target = []
            for i in predictions_oot.columns:
                target.append(i)
            target = target[-3]
            ...
            print('AQUIIIIIIIIIIII: ', predictions_oot["proba"])
            ...
            print('KS STAAAAAAAAAAAT: ',ks_stat)
            ...
            # st.markdown("* PSI: %.2f" % round(psi, 2)) 
            ...
            # d2['PSI-minus'] = d4['proporcao-treino'] - d2['proporcao-oot']
            # d2['PSI-log'] = np.log(d4['proporcao-treino'] / d2['proporcao-oot'])
            # d2['PSI-mult'] = d2['PSI-minus'] * d2['PSI-log']
